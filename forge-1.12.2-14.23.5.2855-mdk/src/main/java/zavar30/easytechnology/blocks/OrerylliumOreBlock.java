...
public class OrerylliumOreBlock extends Block
{
	public OrerylliumOreBlock(String name) 
	{
		super(Material.IRON);
	...
	public OrerylliumOreBlock setCreativeTab(CreativeTabs tab)
	{
	...
	{
		return ETItems.oreryllium_ingot_raw;
	}
